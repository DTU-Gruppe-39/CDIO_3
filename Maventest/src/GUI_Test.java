...
//	Opretter alle felterne
		...
		fields[1].setForeGroundColor(Color.YELLOW);		
		fields[1].setTitle("LÆS FRA ARRAY");
		fields[1].setDescription("LÆS FRA ARRAY");
		...
		fields[3].setDescription("LÆS FRA ARRAY");
		...
		fields[4].setDescription("LÆS FRA ARRAY");	
		...
		fields[5].setDescription("LÆS FRA ARRAY");
		...
		fields[6].setDescription("LÆS FRA ARRAY");	
		...
		fields[7].setDescription("LÆS FRA ARRAY");
		...
		fields[8].setDescription("LÆS FRA ARRAY");	
		...
		fields[9].setDescription("LÆS FRA ARRAY");
		...
		fields[10].setDescription("LÆS FRA ARRAY");	
		...
		fields[11].setDescription("LÆS FRA ARRAY");
		...
		fields[12].setDescription("LÆS FRA ARRAY");	
		...
		fields[13].setDescription("LÆS FRA ARRAY");
		...
		fields[14].setDescription("LÆS FRA ARRAY");	
		...
		fields[15].setDescription("LÆS FRA ARRAY");
		...
		fields[16].setDescription("LÆS FRA ARRAY");	
		...
		fields[17].setDescription("LÆS FRA ARRAY");
		...
		fields[18].setDescription("LÆS FRA ARRAY");
		...
		fields[19].setDescription("LÆS FRA ARRAY");
		...
		fields[20].setDescription("LÆS FRA ARRAY");		
		...
		fields[21].setDescription("LÆS FRA ARRAY");		
		...
		fields[22].setDescription("LÆS FRA ARRAY");		
		...
		fields[23].setDescription("LÆS FRA ARRAY");		
		...
		fields[24].setDescription("LÆS FRA ARRAY");		
